...
const serviceContents: Record<string, ServiceContent> = {
  'garage-door-repair': {
    ...
    outro: {
      ...
      content: [
        ...
        'Call (574) 564-8115 or complete our online contact form.'
      ]
    }
  },
  'garage-door-spring-repair': {
    ...
    outro: {
      ...
      content: [
        'Call (574) 564-8115 for professional garage door spring repair in Elkhart.'
      ]
    }
  },
  'garage-door-opener-repair': {
    ...
    outro: {
      title: 'Call Today',
      content: [
        'Schedule garage door opener repair by calling (574) 564-8115.'
      ]
    }
  },
  ...
  'garage-door-installation': {
    ...
    outro: {
      ...
      content: [
        'Call (574) 564-8115 for a free consultation on garage door installation in Elkhart.'
      ]
    }
  },
  'emergency-garage-door-repair': {
    ...
    outro: {
      ...
      content: [
        'If you need emergency garage door repair in Elkhart, call (574) 564-8115 immediately or submit our online contact form.'
      ]
    }
  }
};
